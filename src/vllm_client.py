...
class VLLMClient:
    ...
    Examples:
        ...
        >>> client = VLLMClient(host="0.0.0.0", server_port=8000)
    ...
    def generate(
        ...
        Args:
            ...
            sampling_params (`SamplingParams`, *optional*):
                ...
                guided_decoding (`GuidedDecodingParams` or `None`, *optional*, defaults to `None`):
                    Guided decoding.
        ...
        response = self.session.post(
            ...
            # TODO: use sampling_params directly
            # json={
            #     "prompts": prompts,
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen2.5-3B").to("cuda")
    client.update_model_params(model)